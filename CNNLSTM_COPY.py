...
from preprocessing import mattyen_rand,data_Standardization,data_normalize,data_normalize_channel,data_normalize_toall
...
def plot_confusion_matrix(cm_normalized, classes,str, save_file=False):
    ...
    plt.title('Confusion Matrix in'+dataset_type)
...
# data_path = 'D:/train_data/Matt_Yen/1t4rbyperson/'
data_path = 'D:\\train_data\\Matt_Yen\\1t4rnewsuffle\\'
...
# x_train, x_test, y_train, y_test = shuffle(x_train, x_test, y_train, y_test, random_state=20)
# x_train, x_test, y_train, y_test = shuffle(x_train, x_test, y_train, y_test, random_state=40)

# data_s0, data_s1, label_s0, label_s1 = shuffle(data_s0, data_s1, label_s0, label_s1, random_state=2)
# data_s0, data_s1, label_s0, label_s1 = shuffle(data_s0, data_s1, label_s0, label_s1, random_state=9)
# data_s0, data_s1, label_s0, label_s1 = shuffle(data_s0, data_s1, label_s0, label_s1, random_state=13)
# data_s0, data_s1, label_s0, label_s1 = shuffle(data_s0, data_s1, label_s0, label_s1, random_state=6)
# for cross sense
# x_train_s0, x_test_s0, y_train_s0, y_test_s0 = train_test_split(data_s0, label_s0, test_size=0.5, random_state=2)
# x_train_s1, x_test_s1, y_train_s1, y_test_s1 = train_test_split(data_s1, label_s1, test_size=0.5, random_state=5)
...
adam=keras.optimizers.Adam(lr=0.005, beta_1=0.5, beta_2=0.999, epsilon=None, decay=0.0001, amsgrad=False)
...
plot_confusion_matrix(cm_normalized, gesture,dataset_type, False)  # plot confusion matrix
