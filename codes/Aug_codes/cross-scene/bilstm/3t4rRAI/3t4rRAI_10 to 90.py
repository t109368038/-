...
#    if i % 10 == 9 or i % 10 == 8 or i % 10 == 7:
    ...
    if i % 10 == 0 or i % 10 == 1 or i % 10 == 2 or i % 10 == 3 or i % 10 == 4 or i % 10 == 9 or i % 10 == 8 or i % 10 == 6 or i % 10 == 7: 
#    if i % 10 == 9:
...
output_dir = '/home/lab210/MattYen_workspace/gest_August/cross-scene/NEW/bilstm/3t4rRAI/10-90/'
#output_dir = h5_dir
