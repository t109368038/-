...
for i in range(0, 1440): #train as 80%
    ...
    if i % 10 == 0 or i % 10 == 1 or i % 10 == 2 or i % 10 == 3 or i % 10 == 4 or i % 10 == 9: 
#    if i % 10 == 9:
...
for i in range(0, 1440): #test as 20%
    if i % 10 == 5 or i % 10 == 6 or i % 10 == 7 or i % 10 == 8:
...
output_dir = '/home/lab210/MattYen_workspace/gest_August/cross-scene/NEW/bilstm/3t4rRDI/40-60/'
#output_dir = h5_dir
