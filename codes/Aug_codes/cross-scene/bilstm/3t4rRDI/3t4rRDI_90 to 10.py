...
#    if i % 10 == 9 or i % 10 == 8 or i % 10 == 7:
    ...
    if i % 10 == 0 or i % 10 == 1 or i % 10 == 2 or i % 10 == 3 or i % 10 == 4 or i % 10 == 5 or i % 10 == 6 or i % 10 == 7 or i % 10 == 8: 
#    if i % 10 == 9:
        x_train_new[i,...] = x_test[i,...]
        y_train_new[i,...] = y_test[i,...]
...
output_dir = '/home/pstudent/for machine/results/cross-scene/3t4rRDI/90-10/'
#output_dir = h5_dir
