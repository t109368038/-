...
#    if i % 10 == 4 or i % 10 == 5 or i % 10 == 6 or i % 10 == 7 or i % 10 == 8 or i % 10 == 9 or i % 10 ==3 or i % 10 == 2 or i % 10 == 1 :
#        x_train_new[i,...] = x_test[i,...]
#        y_train_new[i,...] = y_test[i,...]
...
output_dir = '/home/lab210/MattYen_workspace/gest_August/cross-scene/NEW/lstm/3t4rRDI/0-100/'
#output_dir = h5_dir
