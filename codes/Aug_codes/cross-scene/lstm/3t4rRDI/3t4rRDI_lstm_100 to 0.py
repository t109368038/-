...
output_dir = '/home/lab210/MattYen_workspace/gest_August/cross-scene/NEW/lstm/3t4rRDI/100-0/'
#output_dir = h5_dir
...
#model = load_model(output_dir + 'model_NewConfig_lstm_3t4rRDI_32x32_Gaussian_batch12_ProgressSGD.h5')
#model.load_weights(output_dir + 'weightsNewConfig_lstm_3t4rRDI_32x32_Gaussian_batch12_ProgressSGD.h5', by_name = True)
#score = model.evaluate(x_test, y_test, batch_size=12)
#predictions = model.predict(x_test_new) 
