...
h5_dir='/home/lab210/MattYen-workspace/gest_August/cross-scene/3t4rRDI/'
...
#    if i % 10 == 9 or i % 10 == 8 or i % 10 == 7:
    ...
    if i % 10 == 0 or i % 10 == 1 or i % 10 == 2 or i % 10 == 3 or i % 10 == 4 or i % 10 == 5: 
#    if i % 10 == 9:
        x_train_new[i,...] = x_test[i,...]
        y_train_new[i,...] = y_test[i,...]
...
#    if i % 10 == 0 or i % 10 == 1 or i % 10 == 2 or i % 10 == 3 or i % 10 == 4 or i % 10 == 5 or i % 10 == 6 or i % 10 == 7: 
    if i % 10 == 6 or i % 10 == 7 or i % 10 == 8 or i % 10 == 9:
        x_test_new[i,...] = x_train[i,...]
        y_test_new[i,...] = y_train[i,...]
...
output_dir = '/home/lab210/MattYen_workspace/gest_August/cross-scene/NEW/lstm/3t4rRDI/60-40/'
#output_dir = h5_dir
