...
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_1/1t4rRDI/bilstm/'
#output_dir = h5_dir
...
model.save(output_dir + 'model_NewConfig_bilstm_1t4rRDI_32x32_Gaussian_batch12_ProgressSGD.h5')
model.save_weights(output_dir + 'weights_NewConfig_bilstm_1t4rRDI_32x32_Gaussian_batch12_ProgressSGD.h5')

#==============================================================================
#model = load_model(output_dir + 'model_NewConfig_bilstm_1t4rRDI_32x32_Gaussian_batch12_ProgressSGD.h5')
#model.load_weights(output_dir + 'weights_NewConfig_bilstm_1t4rRDI_32x32_Gaussian_batch12_ProgressSGD.h5', by_name = True)
#score = model.evaluate(x_test, y_test, batch_size=12)
#predictions = model.predict(x_test) 
