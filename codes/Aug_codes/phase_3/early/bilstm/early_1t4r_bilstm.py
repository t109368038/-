...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/early/1t4r/bilstm/'
#
...
parallel_model.save(output_dir  + 'model_1t4r_bilstm_early_gaussian_batch12_ProgressSgd.h5')
parallel_model.save_weights(output_dir  + 'weights_1t4r_bilstm_early_gaussian_batch12_ProgressSgd.h5')
