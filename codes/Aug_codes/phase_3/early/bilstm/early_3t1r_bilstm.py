...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/early/3t1r/bilstm/'
#
...
parallel_model.save(output_dir  + 'model_3t1r_bilstm_early_gaussian_batch12_ProgressSgd.h5')
parallel_model.save_weights(output_dir  + 'weights_3t1r_bilstm_early_gaussian_batch12_ProgressSgd.h5')
