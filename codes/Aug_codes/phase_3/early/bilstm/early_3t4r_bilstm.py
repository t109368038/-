...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/early/3t4r/bilstm/'
#
...
parallel_model.save(output_dir  + 'model_3t4r_bilstm_early_gaussian_batch12_ProgressSgd.h5')
