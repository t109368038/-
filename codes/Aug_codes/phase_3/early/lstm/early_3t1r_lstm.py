...
h5_dir_2='/home/lab210/MattYen_workspace/gest_August/cross-scene/3t1rRAI/'
...
vali_dir_2='/home/lab210/MattYen_workspace/gest_August/cross-scene/3t1rRAI/'
...
#===================================================================#
## 3t1r RDI
x_train_1 = np.concatenate((x_train_1[:,:,:,:,0, np.newaxis], 
                          x_train_1[:,:,:,:,4, np.newaxis], 
                          x_train_1[:,:,:,:,8, np.newaxis]), axis=4)

x_test_1 = np.concatenate((x_test_1[:,:,:,:,0, np.newaxis], 
                          x_test_1[:,:,:,:,4, np.newaxis], 
                          x_test_1[:,:,:,:,8, np.newaxis]), axis=4)
#===================================================================#
###########################################################################################################
...
#    z = Bidirectional(LSTM(512, return_sequences=True))(z)   
    z = LSTM(512, return_sequences=True)(z)   
    z = TimeDistributed(Dropout(0.5))(z)
#    
...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/early/3t1r/lstm/'
#
...
parallel_model.save(output_dir  + 'model_3t1r_lstm_early_gaussian_batch12_ProgressSgd.h5')
parallel_model.save_weights(output_dir  + 'weights_3t1r_lstm_early_gaussian_batch12_ProgressSgd.h5')


#==============================================================================
#model = load_model(output_dir  + 'model_3t4r_lstm_early_gaussian_batch12_ProgressSgd.h5')
#model.load_weights(output_dir  + 'weights_3t4r_lstm_early_gaussian_batch12_ProgressSgd.h5', by_name = True)
