...
h5_dir_2='/home/lab210/MattYen_workspace/gest_August/cross-scene/3t4rRAI/'
...
vali_dir_2='/home/lab210/MattYen_workspace/gest_August/cross-scene/3t4rRAI/'
...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/early/3t4r/lstm/'
#
...
parallel_model.save(output_dir  + 'model_3t4r_lstm_early_gaussian_batch12_ProgressSgd.h5')
parallel_model.save_weights(output_dir  + 'weights_3t4r_lstm_early_gaussian_batch12_ProgressSgd.h5')
...
#score = model.evaluate([x_test_1, x_test_2], [y_test_1], batch_size=12)
