...
#    TimeDistributed(Dropout(0.4)))
    ...
    y = Bidirectional(LSTM(512, return_sequences=True))(y)   
    y = TimeDistributed(Dropout(0.5))(y)
...
#    
    z = TimeDistributed(Dense(12))(combined)
...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/late/3t1r/bilstm/'
#
...
parallel_model.save(output_dir  + 'model_3t1r_bilstm_late_gaussian_batch12_ProgressSgd.h5')
