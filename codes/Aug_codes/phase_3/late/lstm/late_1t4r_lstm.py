...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/late/1t4r/lstm/'
#
...
parallel_model.save(output_dir  + 'model_1t4r_lstm_late_gaussian_batch12_ProgressSgd.h5')
parallel_model.save_weights(output_dir  + 'weights_1t4r_lstm_late_gaussian_batch12_ProgressSgd.h5')
