...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/original_cases/phase_3/late/3t1r/lstm/'
#
...
parallel_model.save(output_dir  + 'model_3t1r_lstm_late_gaussian_batch12_ProgressSgd.h5')
