...
h5_dir='/home/pstudent/DeepSoli Models/gesture_data/Range-Angle_fair comparison/3t4r/lab210_64x16Cropped/'
#vali_dir='/home/pstudent/DeepSoli Models/gesture_data/Range-Doppler_fair comparison/H104_cropped_whole as a testset/'
...
#==============================================================================
#model = load_model(h5_dir + 'model_h104_1t4r_cropped_bi-lstm_RangeDoppler_255-normalized_ProgressSgd.h5')
#model.load_weights(h5_dir + 'weights_h104_1t4r_cropped_bi-lstm_RangeDoppler_255-normalized_ProgressSgd.h5', by_name = True)
...
#count=0;
#for j in range(0, 12):      
#    temp = sum(frames_prob_sum[count:count+10,:])
#    mat_percentage[j, :] = temp/10
#    count+=10        
#    
#mat_percentage = mat_percentage/64
#print('The vali accuracy derived from confusion matrix is:\n')
...
model.save(h5_dir + 'model_GRU_RangeAngle_64x16_255normalized_batch12_ProgressSgd.h5')
model.save_weights(h5_dir + 'weights_GRU_RangeAngle_64x16_255normalized_batch12_ProgressSgd.h5')
