...
from tensorflow.keras.layers import Multiply, Permute, Reshape, Input
...
h5_dir='/home/pstudent/DeepSoli Models/gesture_data/Range-Doppler_fair comparison/3t4r_lab210_NewConfig_cropped_subtractHalfBG/'
#model_dir = '/home/pstudent/DeepSoli Models/gesture_data/Range-Doppler_fair comparison/all as trainset_3t4r/'
vali_dir='/home/pstudent/DeepSoli Models/gesture_data/Range-Doppler_fair comparison/3t4r_H104_NewConfig_cropped_subtractHalfBG/'
...
x_train = np.load(h5_dir + 'x_train_meanstd.npy')
...
#x_test = np.transpose(x_test, (0,1,3,4,2))
x_test = np.load(vali_dir + 'x_test_meanstd.npy')
...
#    Att_Output = Bidirectional(GRU(512, return_sequences=True))(x)
    ...
    Att_Input = TimeDistributed(Dropout(0.5))(Att_Input)
...
history = model.fit(x_train, y_train, 
          batch_size=10, epochs=60, shuffle=True, verbose=1, 
          callbacks=[scheduler],
