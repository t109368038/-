...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/3t4r_bilstm_earlyFusionParallel_batch12_ProgressSgd/'
#
...
model.save(output_dir  + 'model_3t4r_bilstm_earlyFusionParallel_batch12_ProgressSgd.h5')
model.save_weights(output_dir  + 'weights_3t4r_bilstm_earlyFusionParallel_batch12_ProgressSgd.h5')