...
h5_dir_1='/home/lab210/MattYen_workspace/gest_August/3t4rRDI/'
h5_dir_2='/home/lab210/MattYen_workspace/gest_August/3t4rRAI/'
#model_dir = '/home/pstudent/DeepSoli Models/gesture_data/[parallel model]/1t2r_parallel/'
vali_dir_1='/home/lab210/MattYen_workspace/gest_August/3t4rRDI/'
vali_dir_2='/home/lab210/MattYen_workspace/gest_August/3t4rRAI/'
...
#plt.yticks([])
#plt.show()
output_dir = '/home/lab210/MattYen_workspace/gest_August/3t4r_bilstm_lateFusionParallel_batch12_ProgressSgd/'
#
...
fig_acc.savefig(output_dir  +'acc_parallel.png')
...
fig_loss.savefig(output_dir  + 'loss_parallel.png')

np.save(output_dir + 'mat_percentage.npy', mat_percentage)

model.save(output_dir  + 'model_3t4r_bilstm_lateFusionParallel_batch12_ProgressSgd.h5')
model.save_weights(output_dir  + 'weights_3t4r_bilstm_lateFusionParallel_batch12_ProgressSgd.h5')