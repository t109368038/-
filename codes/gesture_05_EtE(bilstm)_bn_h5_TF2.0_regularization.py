...
#model_dir = '/home/pstudent/DeepSoli Models/gesture_data/Range-Doppler_fair comparison/3t4r_all as trainset_cropped/'
...
x_train = np.load(h5_dir + 'x_train_mean-subbed.npy')
...
x_test = np.load(vali_dir + 'x_test_mean-subbed.npy')
...
with tf.device('/gpu:0'):
    ...
    model.add(TimeDistributed(Conv2D(32, (3, 3), strides=1, padding='valid', 
                                     kernel_initializer='random_normal', 
                                     kernel_regularizer=regularizers.l2(L2_regular_const),
#                                     bias_regularizer=regularizers.l2(L2_regular_const)),
                                     activity_regularizer=regularizers.l2(L2_regular_const)),
...
#    model.add(TimeDistributed(BatchNormalization()))
    ...
    model.add(Bidirectional(LSTM(512, 
                                 kernel_initializer='random_normal', 
                                 kernel_regularizer=regularizers.l2(L2_regular_const), 
                                 recurrent_regularizer=regularizers.l2(L2_regular_const),
#                                    bias_regularizer=regularizers.l2(L2_regular_const),
                                 activity_regularizer=regularizers.l2(L2_regular_const),
