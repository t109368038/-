from offline_process_3t4r_for_correct import DataProcessor
...
class Realtime_sys():
    ...
    def SelectFolder(self):
        ...
        if self.sure_select == True:
            self.file_path = filedialog.askopenfilename(parent=root, initialdir='C:/Users/user/Desktop/data/')
            self.browse_text.setText(self.file_path)
        else:
            self.file_path = 'C:/Users/user/Desktop/data/alongx2.npy'
